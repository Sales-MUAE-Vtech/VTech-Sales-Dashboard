...
def load_data():
    sales_26 = pd.read_excel('2026_July/B_Inv_VTEC-Jul2026.xlsx', engine='calamine')
    sales_25 = pd.read_excel('2026_July/B.1_Inv_VTEC-Jul2025.xlsx', engine='calamine')
    quotes_26 = pd.read_excel('2026_July/A_SQ_VTEC-Jul2026.xlsx', engine='calamine')
    quotes_25 = pd.read_excel('2026_July/A.1_SQ_VTEC-Jul2025.xlsx', engine='calamine')
...
st.download_button(
    ...
    file_name="2026-JUL_VTech-Sales_Quotes_Summary.xlsx",
